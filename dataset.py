...
def get_transforms(image_size):
    ...
    transforms_train = albumentations.Compose([
        ...
        albumentations.OneOf([
            #albumentations.MotionBlur(blur_limit=2),
            #albumentations.GaussianBlur(blur_limit=attack_strength),
            #albumentations.GaussNoise(var_limit=(5.0, 30.0)),
        ], p=1.0),

        # albumentations.OneOf([
        #     albumentations.OpticalDistortion(distort_limit=0.3),
    ...
    transforms_val = albumentations.Compose([
        albumentations.Resize(image_size, image_size),
        # albumentations.Blur(blur_limit=attack_strength, p=1),
        # albumentations.GaussianBlur(blur_limit=attack_strength, p=1),
        #albumentations.MedianBlur(blur_limit=attack_strength, p=1),
        #albumentations.JpegCompression(quality_lower=attack_strength, quality_upper=attack_strength, always_apply=True, p=1),
